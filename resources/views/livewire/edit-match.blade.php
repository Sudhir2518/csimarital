        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    Edit match <span class="text-blue-800 text-xl font-bold">{{ $editmatch->first_name }}</span>&nbsp;<span class="text-blue-800 text-xl font-bold">{{ $editmatch->last_name }}</span>&nbsp;under your account </br>
                ...
                <div class="mt-10 sm:mt-0">
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                                      ...
                                      @if($currentPage === 1)
                                            <div class="flex flex-col">
                                                <div class="grid grid-col-1 space-y-10">
                                                  <div class="mx-3  ">
                                                    <form wire:submit.prevent="save" class="grid grid-col-2 gp-2">
                                                      <img src="{{ Storage::url('prop_bust/'. $editmatch->bust_image) }}" class="w-20 h-20 rounded-full md:w-20 md:h-20">
                                                        <label for="bust_image">Upload a new bust size image </label>
                                                        @if ($bust_image)
                                                            Photo Preview:
                                                            <img  src="{{ $bust_image->temporaryUrl() }}" class="w-20 h-20 rounded-full md:w-20 md:h-20">
                                                        @endif
                                                  ...
                                                  <div class="mx-3">
                                                    <form wire:submit.prevent="save">
                                                        ...
                                                        <img  src="{{ Storage::url('prop_full/'. $editmatch->full_image) }}" class="w-20 h-20 rounded-full md:w-20 md:h-20">
                                                        @if ($full_image)
                                                            Photo Preview:
                                                            <img  src="{{ $full_image->temporaryUrl() }}" class="w-20 h-20 rounded-full md:w-20 md:h-20" />
                                                        @endif
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <input wire:model.lazy="place_of_birth" type="text" name="heightplace_of_birth" id="place_of_birth" autocomplete="place_of_birth" placeholder="Place of Birth"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block bg-gray-100 p-2 w-full shadow-sm sm:text-sm @error('place_of_birth') border-red-700  @enderror">
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <select wire:model.lazy="eduqual_id" type="text" name="eduqual_id" id="eduqual_id" autocomplete="eduqual_id"  placeholder="Education Qualifications"
                                                 class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm @error('eduqual_id') border-red-700  @enderror">
                                         ...
                                         @elseif($currentPage === 2)
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <select wire:model.lazy="foccu"  type="text" name="fname" id="fname" autocomplete="fname"
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm @error('moccu') border-red-700  @enderror">
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm @error('brothers') border-red-700  @enderror">
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                @error('diocese_id') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="w-full py-2">

                                                <input wire:model.lazy="church" type="text" name="church" id="church" autocomplete="church" placeholder="church"
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block bg-gray-100 p-2  w-full shadow-sm sm:text-sm @error('country_id') border-red-700  @enderror">
                            ...
                            <div >
                                <livewire:delete-match : id="{{ $editmatch->id}}" />
                         <span class="text-xl font-bold font-sans text-gray-700 " >or <x-danger-button x-data="{}"  x-on:click="window.livewire.emitTo('delete-match','show')" >DELETE</x-danger-button> this match from your account.
                         </div>
                        </div>
                    </div>
                </div>
