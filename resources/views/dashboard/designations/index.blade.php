...
<x-app-layout  title="Designations.index">
                    ...
                    <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                        @foreach ($designations as $designation)
                         ...
                         <tr>
                            ...
                            <td class="px-2 py-4 whitespace-nowrap">
                                {{ $designation->updated_at->format('m/d/y') }}
                            </td>
                            ...
                            <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                ...
                                <div class="flex justify-start space-x-1">
                                    ...
                                    <a href="{{ route('designations.edit', $designation) }}" class="p-1 border-2 border-indigo-200 rounded-md">
                                    ...
                                    <form action="{{ route('designations.delete', $designation) }}" method="POST">
                                        @csrf
                                        @method('Delete')
