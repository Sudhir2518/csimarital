...
<x-app-layout  title="Education Fields">
                        ...
                        <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                            @foreach ($edufields as $edufield)
                             ...
                             <tr>
                                ...
                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $edufield->edufield_name }}
                                </td>



                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $edufield->created_at->format('m/d/y') }}
                                </td>

                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $edufield->updated_at->format('m/d/y') }}
                                </td>
                                ...
                                <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    ...
                                    <div class="flex justify-start space-x-1">
                                        ...
                                        <a href="{{ route('edufields.edit', $edufield) }}" class="p-1 border-2 border-indigo-200 rounded-md">
                                        ...
                                        <form action="{{ route('edufields.delete', $edufield) }}" method="POST">
                                            @csrf
                                            @method('Delete')
