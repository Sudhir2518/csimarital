...
<x-app-layout  title="organizations.index">
                        ...
                        <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                            @foreach ($organizations as $organization)
                             ...
                             <tr>
                                ...
                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $organization->updated_at->format('m/d/y') }}
                                </td>
                                ...
                                <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    ...
                                    <div class="flex justify-start space-x-1">
                                        ...
                                        <a href="{{ route('organizations.edit', $organization) }}" class="p-1 border-2 border-indigo-200 rounded-md">
                                        ...
                                        <form action="{{ route('organizations.delete', $organization) }}" method="POST">
                                            @csrf
                                            @method('Delete')
