...
<x-app-layout  title="Occupations.index">
                        ...
                        <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                            @foreach ($Occupations as $Occupation)
                             ...
                             <tr>
                                ...
                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $Occupation->desgn_name }}
                                </td>



                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $Occupation->created_at->format('m/d/y') }}
                                </td>

                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $Occupation->updated_at->format('m/d/y') }}
                                </td>
                                ...
                                <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    ...
                                    <div class="flex justify-start space-x-1">
                                        ...
                                        <a href="{{ route('Occupations.edit', $Occupation) }}" class="p-1 border-2 border-indigo-200 rounded-md">
                                        ...
                                        <form action="{{ route('Occupations.delete', $Occupation) }}" method="POST">
                                            @csrf
                                            @method('Delete')
